...
import { SignatureIcon } from "@/components/images"

export default function FieldsetAgreement() {
	return (
		<>
			<div className={style.content}>
				<div className={style.head}>
					<div className={style.input_blk}>Leonardo Davinci</div>
					<div className={style.date_blk}>
						<div className={style.date_blk_item}>
							<span>Date of Birth</span>15 April, 1452
						</div>
						<div className={style.date_blk_item}>
							<span>Submitted date</span>02 June, 2023
						</div>
					</div>
				</div>
				<h5>The following pages contain</h5>
				<ol>
					<li>Credit Repair Service Agreement</li>
					<li>Authorization for Credit Repair Action</li>
				...
				<br />
				<p>Credit Repair Service Agreement forLeonardo DaVinci</p>
				...
				<br />
				<div className={style.text_blk}>
					<p>
						In exchange, I, Leonardo DaVinci, agree to pay the following fees as outlined in the following fee schedule: <br />
						At signup for document processing
					</p>
					<div className={style.input_blk}>$0000</div>
				</div>
				<br />
				...
				<p>I, Leonardo DaVinci, hereby acknowledge with my digital signature, receipt of the Notice of Right to Cancel. I confirm the fact that I agree and understand what I am signing, and acknowledge that I have received a copy of my Consumer Credit File Rights.</p>
				<p>Digital Signatures: In 2000, the U.S. Electronic Signatures in Global and National Commerce (ESIGN) Act established electronic records and signatures as legally binding, having the same legal effects as traditional paper documents and handwritten signatures. Read more at the FTC web site:</p>
				<br />
				<h5>Signature </h5>
				<div className={style.signature}>
					<Image width={200} height={160} src={SignatureIcon} alt="" />
				</div>
			</div>
		</>
	)
